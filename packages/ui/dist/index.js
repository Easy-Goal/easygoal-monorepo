...
function HeaderUserMenu({ config }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: containerRef, className: "relative", children: [
      /* @__PURE__ */ jsxRuntime.jsxs("button", { onClick: () => setIsOpen(!isOpen), className: "flex items-center gap-2 px-2 py-1.5 transition-colors hover:bg-foreground/5 rounded-lg", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "hidden sm:block text-foreground/90 text-sm font-medium", children: user.name?.split(" ")[0] }),
        /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ChevronDown, { className: "h-4 w-4 text-foreground/30" })
      ] }),
      isOpen && /* CORREÇÃO DE TRANSPARÊNCIA: Adicionado bg sólido e shadow pesado */
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "absolute right-0 top-full z-[100] mt-2 w-64 rounded-xl border border-border bg-popover p-1.5 shadow-lg", children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-3 py-3 border-b border-border/50", children: [
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "truncate text-sm font-semibold text-foreground", children: user.name }),
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "truncate text-[11px] text-muted-foreground", children: user.email })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "py-1", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("a", { href: getAppUrl("/dashboard"), className: "flex items-center gap-3 rounded-md px-3 py-2 text-sm text-foreground/70 hover:bg-foreground/5", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.LayoutDashboard, { className: "h-4 w-4 opacity-50" }),
            " Painel Principal"
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("a", { href: getAppUrl("/settings/profile"), className: "flex items-center gap-3 rounded-md px-3 py-2 text-sm text-foreground/70 hover:bg-foreground/5", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Settings, { className: "h-4 w-4 opacity-50" }),
            " Editar Perfil"
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs("a", { href: config.docsUrl || "https://docs.easygoal.com.br", target: "_blank", rel: "noreferrer", className: "flex items-center gap-3 rounded-md px-3 py-2 text-sm text-foreground/70 hover:bg-foreground/5", children: [
            /* @__PURE__ */ jsxRuntime.jsx(lucideReact.BookOpen, { className: "h-4 w-4 opacity-50" }),
            " Documenta\xE7\xE3o"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "border-t border-border/50 pt-1", children: /* @__PURE__ */ jsxRuntime.jsxs("button", { onClick: logout, className: "flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm text-red-400 hover:bg-red-400/10", children: [
...
function EasyHeader({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("header", { className: `fixed top-0 left-0 right-0 z-50 transition-all duration-400 ${scrolled ? "bg-background/95 backdrop-blur-md border-b border-border" : "bg-transparent"} ${className}`, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "mx-auto flex h-16 max-w-[1280px] items-center justify-between px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("a", { href: "/", className: "flex items-center gap-3 no-underline shrink-0 mr-4", children: [
      ...
      logoSuffix && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center gap-2 font-mono text-sm border-l border-border/40 pl-3", children: /* @__PURE__ */ jsxRuntime.jsx("span", { className: "opacity-40", children: logoSuffix }) })
    ] }),
...
var CardTitle = react.forwardRef(
  ({ className, ...props }, ref) => /* @__PURE__ */ jsxRuntime.jsx("h3", { ref, className: cn("text-lg font-semibold leading-none tracking-tight text-foreground", className), ...props })
);
...
function Avatar({ src, alt, fallback, size = "md", className, ...props }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      ...props,
      children: src ? /* @__PURE__ */ jsxRuntime.jsx("img", { src, alt: alt ?? "", className: "h-full w-full object-cover" }) : /* @__PURE__ */ jsxRuntime.jsx("span", { className: "flex h-full w-full items-center justify-center font-medium text-orange-400", children: fallback ?? "?" })
    }
  );
}
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn(emptyVariants({ variant }), className), ...props, children: [
    icon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "text-muted-foreground mb-1", children: icon }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { className: "font-medium text-foreground", children: title }),
    description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground max-w-xs", children: description }),
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          ...
          text && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground", children: text })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: cn("flex items-center gap-2 text-muted-foreground", className), ...props, children: [
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-2xl font-bold text-foreground mb-2", children: value }),
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-muted-foreground", children: title }),
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xl font-bold text-foreground", children: value }),
          subtitle && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-xs text-muted-foreground", children: subtitle })
        ] })
      ] })
    }
  );
...
function QuickLinkCard({ title, description, icon, href, className, onClick, ...props }) {
  const inner = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntime.jsx("p", { className: "font-medium text-foreground", children: title }),
      description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "text-sm text-muted-foreground truncate", children: description })
    ] }),
    /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowRight, { className: "h-4 w-4 text-muted-foreground group-hover:text-accent transition-colors shrink-0" })
  ] });
  const baseClass = cn(
        ...
        isDark ? (
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "svg",
            {
              ...
              strokeLinecap: "round",
              strokeLinejoin: "round",
              children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M21 12.79A9 9 0 1 1 11.21 3a7 7 0 0 0 9.79 9.79z" })
            }
          )
        ),
        variant === "label" && /* @__PURE__ */ jsxRuntime.jsx("span", { children: isDark ? "Claro" : "Escuro" })
      ]
    }
  );
}
