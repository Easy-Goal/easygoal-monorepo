...
var BellIcon = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" }),
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M13.73 21a2 2 0 0 1-3.46 0" })
] });
var CheckIcon = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("polyline", { points: "20 6 9 17 4 12" }) });
var TrashIcon = () => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("polyline", { points: "3 6 5 6 21 6" }),
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M19 6l-1 14H6L5 6" }),
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M10 11v6M14 11v6" }),
  /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M9 6V4h6v2" })
] });
function NotificationBell({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S.wrap, ref, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(BellIcon, {}),
          unreadCount > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: S.badge, children: unreadCount > 9 ? "9+" : unreadCount })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S.dropdown, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S.dropdownHeader, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S.dropdownTitle, children: "Notifica\xE7\xF5es" }),
        unreadCount > 0 && onMarkAllRead && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: S.markAllBtn, onClick: () => onMarkAllRead(), children: "Marcar todas como lidas" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S.list, children: notifications.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S.empty, children: "Nenhuma notifica\xE7\xE3o" }) : notifications.slice(0, 10).map((n) => {
        const isUnread = !n.readAt;
        const inner = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          isUnread && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: S.dot }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S.itemContent, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S.itemTitle(isUnread), children: n.title }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S.itemMsg, children: n.message }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: S.itemTime, children: formatTimeAgo(n.createdAt) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: S.actions, children: [
            isUnread && onMarkRead && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "button",
              {
                style: S.actionBtn,
                ...
                children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(CheckIcon, {})
              }
            ),
        ...
        return n.actionUrl ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: n.actionUrl, style: S.item(isUnread), onClick: () => setIsOpen(false), children: inner }, n.id) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S.item(isUnread), onClick: () => {
          if (isUnread && onMarkRead) onMarkRead(n.id);
        }, children: inner }, n.id);
      }) }),
      allNotificationsUrl && notifications.length > 10 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: S.footer, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("a", { href: allNotificationsUrl, style: S.footerLink, onClick: () => setIsOpen(false), children: "Ver todas as notifica\xE7\xF5es" }) })
    ] })
  ] });
}
...
function RankBadge({ rankName, size = "sm", showLabel = true, className }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "span",
    {
      ...
      title: config.label,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: config.emoji }),
        showLabel && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: config.label })
      ]
    }
  );
}
...
var ChevronDown = () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("polyline", { points: "6 9 12 15 18 9" }) });
var UserIcon = () => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
var BookIcon = () => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
var LogOutIcon = () => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
function UserMenu({ user, onSignOut, settingsUrl, docsUrl }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S2.wrap, ref, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { style: S2.trigger, onClick: () => setIsOpen((o) => !o), children: [
      user.avatarUrl ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        "img",
        {
          src: user.avatarUrl,
      ...
      ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S2.avatar(false), children: initials }),
      user.rankName && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RankBadge, { rankName: user.rankName, size: "sm", showLabel: false }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { maxWidth: 110, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 13 }, children: firstName }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: S2.chevron, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronDown, {}) })
    ] }),
    isOpen && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S2.dropdown, children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S2.userInfo, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }, children: user.rankName && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(RankBadge, { rankName: user.rankName, size: "sm", showLabel: true }) }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: S2.userName, children: user.name ?? user.email }),
        user.email && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { style: S2.userEmail, children: user.email })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: S2.section, children: [
        settingsUrl && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("a", { href: settingsUrl, style: S2.menuItem, onClick: () => setIsOpen(false), children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(UserIcon, {}),
          " Meu perfil"
        ] }),
        docsUrl && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("a", { href: docsUrl, target: "_blank", rel: "noopener noreferrer", style: S2.menuItem, onClick: () => setIsOpen(false), children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BookIcon, {}),
          " Documenta\xE7\xE3o"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { padding: "4px 0" }, children: onSignOut && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { style: S2.menuItemDanger, onClick: () => {
        setIsOpen(false);
        onSignOut();
      }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LogOutIcon, {}),
        " Sair"
      ] }) })
    ] })
  ] });
...
function EasyHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("header", { style: S3.header(scrolled), className, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: S3.inner, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("a", { href: "/", style: S3.logoWrap, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Logo, { variant: logoVariant, width: 108 }),
      logoSuffix && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: S3.suffix, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: S3.slash, children: "/" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: S3.suffixText, children: logoSuffix })
      ] })
    ] }),
    navLinks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "nav",
      {
        style: {
          ...S3.nav,
        ...
        children: navLinks.map(({ label, href }) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("a", { href, style: S3.navLink, children: label }, href))
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: S3.right, children: user ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      notifications !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        NotificationBell,
        {
          notifications,
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ctaSlot ?? (loginUrl && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("a", { href: loginUrl, style: S3.loginLink, children: "Entrar" })) }) })
  ] }) });
}
