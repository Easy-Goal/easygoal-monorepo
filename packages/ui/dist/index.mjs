...
var BellIcon = () => /* @__PURE__ */ jsxs("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
  /* @__PURE__ */ jsx("path", { d: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" }),
  /* @__PURE__ */ jsx("path", { d: "M13.73 21a2 2 0 0 1-3.46 0" })
] });
var CheckIcon = () => /* @__PURE__ */ jsx("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsx("polyline", { points: "20 6 9 17 4 12" }) });
var TrashIcon = () => /* @__PURE__ */ jsxs("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
function NotificationBell({
  ...
  return /* @__PURE__ */ jsxs("div", { style: S.wrap, ref, children: [
    /* @__PURE__ */ jsxs(
      "button",
      {
        style: S.btn,
        ...
        children: [
          ...
          unreadCount > 0 && /* @__PURE__ */ jsx("span", { style: S.badge, children: unreadCount > 9 ? "9+" : unreadCount })
        ]
      }
    ),
    isOpen && /* @__PURE__ */ jsxs("div", { style: S.dropdown, children: [
      /* @__PURE__ */ jsxs("div", { style: S.dropdownHeader, children: [
        /* @__PURE__ */ jsx("p", { style: S.dropdownTitle, children: "Notifica\xE7\xF5es" }),
        unreadCount > 0 && onMarkAllRead && /* @__PURE__ */ jsx("button", { style: S.markAllBtn, onClick: () => onMarkAllRead(), children: "Marcar todas como lidas" })
      ] }),
      /* @__PURE__ */ jsx("div", { style: S.list, children: notifications.length === 0 ? /* @__PURE__ */ jsx("p", { style: S.empty, children: "Nenhuma notifica\xE7\xE3o" }) : notifications.slice(0, 10).map((n) => {
        const isUnread = !n.readAt;
        const inner = /* @__PURE__ */ jsxs(Fragment, { children: [
          isUnread && /* @__PURE__ */ jsx("span", { style: S.dot }),
          /* @__PURE__ */ jsxs("div", { style: S.itemContent, children: [
            /* @__PURE__ */ jsx("p", { style: S.itemTitle(isUnread), children: n.title }),
            /* @__PURE__ */ jsx("p", { style: S.itemMsg, children: n.message }),
            /* @__PURE__ */ jsx("p", { style: S.itemTime, children: formatTimeAgo(n.createdAt) })
          ] }),
          /* @__PURE__ */ jsxs("div", { style: S.actions, children: [
            isUnread && onMarkRead && /* @__PURE__ */ jsx(
              "button",
              {
                style: S.actionBtn,
        ...
        return n.actionUrl ? /* @__PURE__ */ jsx("a", { href: n.actionUrl, style: S.item(isUnread), onClick: () => setIsOpen(false), children: inner }, n.id) : /* @__PURE__ */ jsx("div", { style: S.item(isUnread), onClick: () => {
          if (isUnread && onMarkRead) onMarkRead(n.id);
        }, children: inner }, n.id);
      }) }),
      allNotificationsUrl && notifications.length > 10 && /* @__PURE__ */ jsx("div", { style: S.footer, children: /* @__PURE__ */ jsx("a", { href: allNotificationsUrl, style: S.footerLink, onClick: () => setIsOpen(false), children: "Ver todas as notifica\xE7\xF5es" }) })
    ] })
  ] });
}
