...
function HeaderUserMenu({ config }) {
  ...
  if (!isReady) return /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-white/5 animate-pulse" });
  if (!user) {
    return /* @__PURE__ */ jsx(
      "button",
      {
  ...
  return /* @__PURE__ */ jsxs("div", { ref: containerRef, className: "relative", children: [
    ...
    isOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full z-50 mt-2 w-64 rounded-xl border border-white/10 bg-[#1e2536] p-1.5 shadow-2xl", children: [
